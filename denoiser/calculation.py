...
def calc():
    ...
    with h5py.File("../../param/video_embeddings_40_June_aug.hdf5", "r") as hf_emb:
    ...
    denoiser.denoiser_model = torch.load("../../param/denoiser_0.2_rl.pkl", map_location=torch.device('cpu'))
