...
from policy_net_regression_new import PolicyNetRegression
...
parser.add_argument('--train-data', dest="train_data_path", type=str, default="../dataset/train_data_final_filter_p_large.hdf5")
parser.add_argument('--test-data', dest="test_data_path", type=str, default="../dataset/test_data_final_filter_p_large.hdf5")
...
if args.eval == False:
    for ep in range(args.epoch):
        # State tracker
        stat = {
            "train_last_acc": 0, "train_acc": 0, "train_last_count": 0, "train_count": 0, "train_loss_pos": 0, "train_loss_neg": 0, 
            "test_last_acc": 0, "test_acc": 0, "test_last_count": 0, "test_count": 0, "test_loss_pos": 0, "test_loss_neg": 0
        }
