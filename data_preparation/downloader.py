...
def main(argv = None):
    ...
    parser.add_argument('--sleep', '-s', type=float, default=0.1, help='sleep time')
    ...
    try:
        ...
        with io.open(output, 'w', encoding='utf8') as fp:
            ...
            for comment in download_comments(youtube_id, args.sort, sleep=args.sleep, proxy=args.proxy):
